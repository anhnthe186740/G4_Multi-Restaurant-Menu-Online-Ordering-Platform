            ...
            <div className="grid grid-cols-3 gap-6 mb-6">
                ...
                <div className="bg-[#142920] rounded-xl p-6 border border-[#1f3d2f]">
                    ...
                    <div className="flex items-baseline gap-2">
                        <h2 className="text-4xl font-bold text-white">{overview?.totalRestaurants?.toLocaleString() || '1,240'}</h2>
                        <span className="text-[#00ff88] text-sm font-semibold">+45.7%</span>
                    </div>
                </div>
                ...
                <div className="bg-[#142920] rounded-xl p-6 border border-[#1f3d2f]">
                    ...
                    <div className="flex items-baseline gap-2">
                        ...
                        <span className="text-[#00ff88] text-sm font-semibold">+125.4%</span>
                    </div>
                </div>
                ...
                <div className="bg-[#142920] rounded-xl p-6 border border-[#1f3d2f]">
                    ...
                    <div className="flex items-baseline gap-2">
                        <h2 className="text-4xl font-bold text-white">{overview?.pendingRequests || '12'}</h2>
